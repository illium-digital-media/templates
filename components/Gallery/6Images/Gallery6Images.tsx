...
const Gallery6Images: React.FC = () => {
  const imageData = [
    {
      imageSrc: 'https://csimg.nyc3.digitaloceanspaces.com/Gallery/house1.jpg',
      title: 'Modern Architectural Design',
      text: 'Li Europan lingues es membres del sam familie. Lor separat existentie es un myth.',
    },
    {
      imageSrc: 'https://csimg.nyc3.digitaloceanspaces.com/Gallery/house2.jpg',
      title: 'Modern Architectural Design',
      text: 'Li Europan lingues es membres del sam familie. Lor separat existentie es un myth.',
    },
    {
      imageSrc: 'https://csimg.nyc3.digitaloceanspaces.com/Gallery/house3.jpg',
      title: 'Modern Architectural Design',
      text: 'Li Europan lingues es membres del sam familie. Lor separat existentie es un myth.',
    },
    {
      imageSrc: 'https://csimg.nyc3.digitaloceanspaces.com/Gallery/house4.jpg',
      title: 'Modern Architectural Design',
      text: 'Li Europan lingues es membres del sam familie. Lor separat existentie es un myth.',
    },
    {
      imageSrc: 'https://csimg.nyc3.digitaloceanspaces.com/Gallery/house5.jpg',
      title: 'Modern Architectural Design',
      text: 'Li Europan lingues es membres del sam familie. Lor separat existentie es un myth.',
    },
    {
      imageSrc: 'https://csimg.nyc3.digitaloceanspaces.com/Gallery/house6.jpg',
      title: 'Modern Architectural Design',
      text: 'Li Europan lingues es membres del sam familie. Lor separat existentie es un myth.',
    },
  ];
