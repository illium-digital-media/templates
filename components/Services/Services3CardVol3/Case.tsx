const Case: React.FC<{ styling: string }> = (props) => {
    return (
        <svg className={props.styling} fill="#042925" width="800px" height="800px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
